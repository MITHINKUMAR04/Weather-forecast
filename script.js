...
// Function to format the date to show the next five days
...
async function updateWeatherForecast() {
  try {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      dayElement.innerText = nextfiveDays[i];
      iconElement.src = `https://openweathermap.org/img/wn/${data.list[i * 8].weather[0].icon}@2x.png`;
